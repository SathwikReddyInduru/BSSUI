          ...
          <div className={styles.infoSection}>
            <div className={styles.fieldRow}>
              <label className={styles.fieldLabel}>
                {getLabel('viewRole.RoleName')}
              </label>

              <div className={styles.fieldValuePlain}>
                {roleName}
              </div>
            </div>
            ...
            <div className={styles.fieldRow}>
              <label className={styles.fieldLabel}>
                {getLabel('viewRole.RoleDescription')}
              </label>
                ...
                >
                  ...
                  <div className={styles.privilegesContainer}>
                    ...
                    {module.privileges?.length > 0 ? (
                      ...
                      <div className={styles.noPrivileges}>
                        {getLabel('viewRole.NoPrivileges')}
                      </div>
                    )}
                  </div>
                </div>
